...
private:
  ...
  rclcpp::Publisher<umdloop_theseus_can_messages::msg::CANA>::SharedPtr smc_can_publisher_;
  rclcpp::Subscription<umdloop_theseus_can_messages::msg::CANA>::SharedPtr smc_can_subscriber_;
