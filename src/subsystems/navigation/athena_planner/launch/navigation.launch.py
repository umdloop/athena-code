...
def generate_launch_description():
    ...
    # Relays the ZED point cloud to the topic Nav2 costmaps expect.
    # Not needed in sim — point_cloud_filterer writes to that topic directly.
