...
return_type ODriveHardwareInterface::write(const rclcpp::Time&, const rclcpp::Duration&) {
    for (auto& axis : axes_) {
        ...
        // Since we are implementing a gearbox, what goes to the motors is different than what we want on the arms
        // If I want my arm to move 30 degrees, the motor must move 30 * gear_ratio
