...
public:
  ...
  double calculate_joint_linear_velocity_from_motor_velocity(
  ...
  int16_t calculate_motor_position_from_desired_joint_displacement(
  ...
  int16_t calculate_motor_velocity_from_desired_joint_linear_velocity(
    double joint_velocity, int gear_ratio, double meters_per_deg);

  void format_control_command(CANLib::CanFrame & frame, ServoJoint & joint);
